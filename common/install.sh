...
ui_print ""
ui_print "VERSION: 4.5.4 - 18/08/2022"
ui_print ""
...
wget -O "${MODPATH}/system/bin/fstrim" "https://raw.githubusercontent.com/raidenkkj/Raiden-Tweaks/main/fstrim"
